...
RSpec.describe ESI::Client::Contract do
  ...
  describe "#get_character_contract_bids" do
    ...
    context "when the response is 503" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/contracts/1234567890/bids/").to_return(body: response.to_json, status: 503)
      end

      it "raises a ESI::Errors::ServiceUnavailableError error" do
        expect { client.get_character_contract_bids(character_id: "1234567890", contract_id: "1234567890") }.to raise_error(ESI::Errors::ServiceUnavailableError)
      end
    end
    ...
    context "when the response is 504" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/contracts/1234567890/bids/").to_return(body: response.to_json, status: 504)
      end

      it "raises a ESI::Errors::GatewayTimeoutError error" do
        expect { client.get_character_contract_bids(character_id: "1234567890", contract_id: "1234567890") }.to raise_error(ESI::Errors::GatewayTimeoutError)
      end
    end
  end
  ...
  describe "#get_character_contract_items" do
    ...
    context "when the response is 503" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/contracts/1234567890/items/").to_return(body: response.to_json, status: 503)
      end

      it "raises a ESI::Errors::ServiceUnavailableError error" do
        expect { client.get_character_contract_items(character_id: "1234567890", contract_id: "1234567890") }.to raise_error(ESI::Errors::ServiceUnavailableError)
      end
    end
    ...
    context "when the response is 504" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/contracts/1234567890/items/").to_return(body: response.to_json, status: 504)
      end

      it "raises a ESI::Errors::GatewayTimeoutError error" do
        expect { client.get_character_contract_items(character_id: "1234567890", contract_id: "1234567890") }.to raise_error(ESI::Errors::GatewayTimeoutError)
      end
    end
  end
  ...
  describe "#get_character_contracts" do
    ...
    context "when the response is 503" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/contracts/").to_return(body: response.to_json, status: 503)
      end

      it "raises a ESI::Errors::ServiceUnavailableError error" do
        expect { client.get_character_contracts(character_id: "1234567890") }.to raise_error(ESI::Errors::ServiceUnavailableError)
      end
    end
    ...
    context "when the response is 504" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/contracts/").to_return(body: response.to_json, status: 504)
      end

      it "raises a ESI::Errors::GatewayTimeoutError error" do
        expect { client.get_character_contracts(character_id: "1234567890") }.to raise_error(ESI::Errors::GatewayTimeoutError)
      end
    end
  end
  ...
  describe "#get_contracts_public_bids_contract" do
    ...
    context "when the response is 503" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/contracts/public/bids/1234567890/").to_return(body: response.to_json, status: 503)
      end

      it "raises a ESI::Errors::ServiceUnavailableError error" do
        expect { client.get_contracts_public_bids_contract(contract_id: "1234567890") }.to raise_error(ESI::Errors::ServiceUnavailableError)
      end
    end
    ...
    context "when the response is 504" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/contracts/public/bids/1234567890/").to_return(body: response.to_json, status: 504)
      end

      it "raises a ESI::Errors::GatewayTimeoutError error" do
        expect { client.get_contracts_public_bids_contract(contract_id: "1234567890") }.to raise_error(ESI::Errors::GatewayTimeoutError)
      end
    end
  end
  ...
  describe "#get_contracts_public_items_contract" do
    ...
    context "when the response is 503" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/contracts/public/items/1234567890/").to_return(body: response.to_json, status: 503)
      end

      it "raises a ESI::Errors::ServiceUnavailableError error" do
        expect { client.get_contracts_public_items_contract(contract_id: "1234567890") }.to raise_error(ESI::Errors::ServiceUnavailableError)
      end
    end
    ...
    context "when the response is 504" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/contracts/public/items/1234567890/").to_return(body: response.to_json, status: 504)
      end

      it "raises a ESI::Errors::GatewayTimeoutError error" do
        expect { client.get_contracts_public_items_contract(contract_id: "1234567890") }.to raise_error(ESI::Errors::GatewayTimeoutError)
      end
    end
  end
  ...
  describe "#get_contracts_public_region" do
    ...
    context "when the response is 503" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/contracts/public/1234567890/").to_return(body: response.to_json, status: 503)
      end

      it "raises a ESI::Errors::ServiceUnavailableError error" do
        expect { client.get_contracts_public_region(region_id: "1234567890") }.to raise_error(ESI::Errors::ServiceUnavailableError)
      end
    end
    ...
    context "when the response is 504" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/contracts/public/1234567890/").to_return(body: response.to_json, status: 504)
      end

      it "raises a ESI::Errors::GatewayTimeoutError error" do
        expect { client.get_contracts_public_region(region_id: "1234567890") }.to raise_error(ESI::Errors::GatewayTimeoutError)
      end
    end
  end
  ...
  describe "#get_corporation_contract_bids" do
    ...
    context "when the response is 503" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/corporations/1234567890/contracts/1234567890/bids/").to_return(body: response.to_json, status: 503)
      end

      it "raises a ESI::Errors::ServiceUnavailableError error" do
        expect { client.get_corporation_contract_bids(contract_id: "1234567890", corporation_id: "1234567890") }.to raise_error(ESI::Errors::ServiceUnavailableError)
      end
    end
    ...
    context "when the response is 504" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/corporations/1234567890/contracts/1234567890/bids/").to_return(body: response.to_json, status: 504)
      end

      it "raises a ESI::Errors::GatewayTimeoutError error" do
        expect { client.get_corporation_contract_bids(contract_id: "1234567890", corporation_id: "1234567890") }.to raise_error(ESI::Errors::GatewayTimeoutError)
      end
    end
  end
  ...
  describe "#get_corporation_contract_items" do
    ...
    context "when the response is 503" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/corporations/1234567890/contracts/1234567890/items/").to_return(body: response.to_json, status: 503)
      end

      it "raises a ESI::Errors::ServiceUnavailableError error" do
        expect { client.get_corporation_contract_items(contract_id: "1234567890", corporation_id: "1234567890") }.to raise_error(ESI::Errors::ServiceUnavailableError)
      end
    end
    ...
    context "when the response is 504" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/corporations/1234567890/contracts/1234567890/items/").to_return(body: response.to_json, status: 504)
      end

      it "raises a ESI::Errors::GatewayTimeoutError error" do
        expect { client.get_corporation_contract_items(contract_id: "1234567890", corporation_id: "1234567890") }.to raise_error(ESI::Errors::GatewayTimeoutError)
      end
    end
  ...
  describe "#get_corporation_contracts" do
    ...
    context "when the response is 503" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/corporations/1234567890/contracts/").to_return(body: response.to_json, status: 503)
      end

      it "raises a ESI::Errors::ServiceUnavailableError error" do
        expect { client.get_corporation_contracts(corporation_id: "1234567890") }.to raise_error(ESI::Errors::ServiceUnavailableError)
      end
    end
    ...
    context "when the response is 504" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/corporations/1234567890/contracts/").to_return(body: response.to_json, status: 504)
      end

      it "raises a ESI::Errors::GatewayTimeoutError error" do
        expect { client.get_corporation_contracts(corporation_id: "1234567890") }.to raise_error(ESI::Errors::GatewayTimeoutError)
      end
    end
  end
end
