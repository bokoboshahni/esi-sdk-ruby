...
RSpec.describe ESI::Client::Killmail do
  ...
  describe "#get_character_killmails_recent" do
    ...
    context "when the response is 503" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/killmails/recent/").to_return(body: response.to_json, status: 503)
      end

      it "raises a ESI::Errors::ServiceUnavailableError error" do
        expect { client.get_character_killmails_recent(character_id: "1234567890") }.to raise_error(ESI::Errors::ServiceUnavailableError)
      end
    end
    ...
    context "when the response is 504" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/killmails/recent/").to_return(body: response.to_json, status: 504)
      end

      it "raises a ESI::Errors::GatewayTimeoutError error" do
        expect { client.get_character_killmails_recent(character_id: "1234567890") }.to raise_error(ESI::Errors::GatewayTimeoutError)
      end
    end
  end
  ...
  describe "#get_corporation_killmails_recent" do
    ...
    context "when the response is 503" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/corporations/1234567890/killmails/recent/").to_return(body: response.to_json, status: 503)
      end

      it "raises a ESI::Errors::ServiceUnavailableError error" do
        expect { client.get_corporation_killmails_recent(corporation_id: "1234567890") }.to raise_error(ESI::Errors::ServiceUnavailableError)
      end
    end
    ...
    context "when the response is 504" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/corporations/1234567890/killmails/recent/").to_return(body: response.to_json, status: 504)
      end

      it "raises a ESI::Errors::GatewayTimeoutError error" do
        expect { client.get_corporation_killmails_recent(corporation_id: "1234567890") }.to raise_error(ESI::Errors::GatewayTimeoutError)
      end
    end
  end
  ...
  describe "#get_killmail_killmail_hash" do
    ...
    context "when the response is 503" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/killmails/1234567890/1234567890/").to_return(body: response.to_json, status: 503)
      end

      it "raises a ESI::Errors::ServiceUnavailableError error" do
        expect { client.get_killmail_killmail_hash(killmail_hash: "1234567890", killmail_id: "1234567890") }.to raise_error(ESI::Errors::ServiceUnavailableError)
      end
    end
    ...
    context "when the response is 504" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/killmails/1234567890/1234567890/").to_return(body: response.to_json, status: 504)
      end

      it "raises a ESI::Errors::GatewayTimeoutError error" do
        expect { client.get_killmail_killmail_hash(killmail_hash: "1234567890", killmail_id: "1234567890") }.to raise_error(ESI::Errors::GatewayTimeoutError)
      end
    end
  end
end
