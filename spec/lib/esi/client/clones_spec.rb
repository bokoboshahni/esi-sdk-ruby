...
RSpec.describe ESI::Client::Clone do
  ...
  describe "#get_character_clones" do
    context "when the response is 200" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/clones/").to_return(body: response.to_json)
      end
    ...
    context "when the response is 400" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/clones/").to_return(body: response.to_json, status: 400)
      end
    ...
    context "when the response is 401" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/clones/").to_return(body: response.to_json, status: 401)
      end
    ...
    context "when the response is 403" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/clones/").to_return(body: response.to_json, status: 403)
      end
    ...
    context "when the response is 420" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/clones/").to_return(body: response.to_json, status: 420)
      end
    ...
    context "when the response is 500" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/clones/").to_return(body: response.to_json, status: 500)
      end
    ...
    context "when the response is 503" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/clones/").to_return(body: response.to_json, status: 503)
      end

      it "raises a ESI::Errors::ServiceUnavailableError error" do
        expect { client.get_character_clones(character_id: "1234567890") }.to raise_error(ESI::Errors::ServiceUnavailableError)
      end
    end
    ...
    context "when the response is 504" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/clones/").to_return(body: response.to_json, status: 504)
      end

      it "raises a ESI::Errors::GatewayTimeoutError error" do
        expect { client.get_character_clones(character_id: "1234567890") }.to raise_error(ESI::Errors::GatewayTimeoutError)
      end
    end
  end
  ...
  describe "#get_character_implants" do
    context "when the response is 200" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/implants/").to_return(body: response.to_json)
      end
    ...
    context "when the response is 400" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/implants/").to_return(body: response.to_json, status: 400)
      end
    ...
    context "when the response is 401" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/implants/").to_return(body: response.to_json, status: 401)
      end
    ...
    context "when the response is 403" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/implants/").to_return(body: response.to_json, status: 403)
      end
    ...
    context "when the response is 420" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/implants/").to_return(body: response.to_json, status: 420)
      end
    ...
    context "when the response is 500" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/implants/").to_return(body: response.to_json, status: 500)
      end
    ...
    context "when the response is 503" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/implants/").to_return(body: response.to_json, status: 503)
      end

      it "raises a ESI::Errors::ServiceUnavailableError error" do
        expect { client.get_character_implants(character_id: "1234567890") }.to raise_error(ESI::Errors::ServiceUnavailableError)
      end
    end
    ...
    context "when the response is 504" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/implants/").to_return(body: response.to_json, status: 504)
      end

      it "raises a ESI::Errors::GatewayTimeoutError error" do
        expect { client.get_character_implants(character_id: "1234567890") }.to raise_error(ESI::Errors::GatewayTimeoutError)
      end
    end
  end
end
