...
RSpec.describe ESI::Client::Wallet, type: :stub do
  ...
  describe "#get_character_wallet" do
    context "when the response is 200" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/wallet/").to_return(body: response.to_json)
      end
    ...
    context "when the response is 400" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/wallet/").to_return(body: response.to_json, status: 400)
      end
    ...
    context "when the response is 401" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/wallet/").to_return(body: response.to_json, status: 401)
      end
    ...
    context "when the response is 403" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/wallet/").to_return(body: response.to_json, status: 403)
      end
    ...
    context "when the response is 420" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/wallet/").to_return(body: response.to_json, status: 420)
      end
    ...
    context "when the response is 500" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/wallet/").to_return(body: response.to_json, status: 500)
      end
  ...
  describe "#get_character_wallet_journal" do
    context "when the response is 200" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/wallet/journal/").to_return(body: response.to_json)
      end
    ...
    context "when the response is 400" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/wallet/journal/").to_return(body: response.to_json, status: 400)
      end
    ...
    context "when the response is 401" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/wallet/journal/").to_return(body: response.to_json, status: 401)
      end
    ...
    context "when the response is 403" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/wallet/journal/").to_return(body: response.to_json, status: 403)
      end
    ...
    context "when the response is 420" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/wallet/journal/").to_return(body: response.to_json, status: 420)
      end
    ...
    context "when the response is 500" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/wallet/journal/").to_return(body: response.to_json, status: 500)
      end
  ...
  describe "#get_corporation_wallets" do
    context "when the response is 200" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/corporations/1234567890/wallets/").to_return(body: response.to_json)
      end
    ...
    context "when the response is 400" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/corporations/1234567890/wallets/").to_return(body: response.to_json, status: 400)
      end
    ...
    context "when the response is 401" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/corporations/1234567890/wallets/").to_return(body: response.to_json, status: 401)
      end
    ...
    context "when the response is 403" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/corporations/1234567890/wallets/").to_return(body: response.to_json, status: 403)
      end
    ...
    context "when the response is 420" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/corporations/1234567890/wallets/").to_return(body: response.to_json, status: 420)
      end
    ...
    context "when the response is 500" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/corporations/1234567890/wallets/").to_return(body: response.to_json, status: 500)
      end
  ...
  describe "#get_corporation_wallets_division_journal" do
    context "when the response is 200" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/corporations/1234567890/wallets/1234567890/journal/").to_return(body: response.to_json)
      end
    ...
    context "when the response is 400" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/corporations/1234567890/wallets/1234567890/journal/").to_return(body: response.to_json, status: 400)
      end
    ...
    context "when the response is 401" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/corporations/1234567890/wallets/1234567890/journal/").to_return(body: response.to_json, status: 401)
      end
    ...
    context "when the response is 403" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/corporations/1234567890/wallets/1234567890/journal/").to_return(body: response.to_json, status: 403)
      end
    ...
    context "when the response is 420" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/corporations/1234567890/wallets/1234567890/journal/").to_return(body: response.to_json, status: 420)
      end
    ...
    context "when the response is 500" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/corporations/1234567890/wallets/1234567890/journal/").to_return(body: response.to_json, status: 500)
      end
