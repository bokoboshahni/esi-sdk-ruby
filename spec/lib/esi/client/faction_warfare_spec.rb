...
RSpec.describe ESI::Client::FactionWarfare, type: :stub do
  ...
  describe "#get_character_fw_stats" do
    context "when the response is 200" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/fw/stats/").to_return(body: response.to_json)
      end
    ...
    context "when the response is 400" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/fw/stats/").to_return(body: response.to_json, status: 400)
      end
    ...
    context "when the response is 401" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/fw/stats/").to_return(body: response.to_json, status: 401)
      end
    ...
    context "when the response is 403" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/fw/stats/").to_return(body: response.to_json, status: 403)
      end
    ...
    context "when the response is 420" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/fw/stats/").to_return(body: response.to_json, status: 420)
      end
    ...
    context "when the response is 500" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/characters/1234567890/fw/stats/").to_return(body: response.to_json, status: 500)
      end
  ...
  describe "#get_corporation_fw_stats" do
    context "when the response is 200" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/corporations/1234567890/fw/stats/").to_return(body: response.to_json)
      end
    ...
    context "when the response is 400" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/corporations/1234567890/fw/stats/").to_return(body: response.to_json, status: 400)
      end
    ...
    context "when the response is 401" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/corporations/1234567890/fw/stats/").to_return(body: response.to_json, status: 401)
      end
    ...
    context "when the response is 403" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/corporations/1234567890/fw/stats/").to_return(body: response.to_json, status: 403)
      end
    ...
    context "when the response is 420" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/corporations/1234567890/fw/stats/").to_return(body: response.to_json, status: 420)
      end
    ...
    context "when the response is 500" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/corporations/1234567890/fw/stats/").to_return(body: response.to_json, status: 500)
      end
  ...
  describe "#get_fw_leaderboard_characters" do
    context "when the response is 200" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/fw/leaderboards/characters/").to_return(body: response.to_json)
      end
    ...
    context "when the response is 400" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/fw/leaderboards/characters/").to_return(body: response.to_json, status: 400)
      end
    ...
    context "when the response is 420" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/fw/leaderboards/characters/").to_return(body: response.to_json, status: 420)
      end
    ...
    context "when the response is 500" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/fw/leaderboards/characters/").to_return(body: response.to_json, status: 500)
      end
  ...
  describe "#get_fw_leaderboard_corporations" do
    context "when the response is 200" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/fw/leaderboards/corporations/").to_return(body: response.to_json)
      end
    ...
    context "when the response is 400" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/fw/leaderboards/corporations/").to_return(body: response.to_json, status: 400)
      end
    ...
    context "when the response is 420" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/fw/leaderboards/corporations/").to_return(body: response.to_json, status: 420)
      end
    ...
    context "when the response is 500" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/fw/leaderboards/corporations/").to_return(body: response.to_json, status: 500)
      end
  ...
  describe "#get_fw_leaderboards" do
    context "when the response is 200" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/fw/leaderboards/").to_return(body: response.to_json)
      end
    ...
    context "when the response is 400" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/fw/leaderboards/").to_return(body: response.to_json, status: 400)
      end
    ...
    context "when the response is 420" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/fw/leaderboards/").to_return(body: response.to_json, status: 420)
      end
    ...
    context "when the response is 500" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/fw/leaderboards/").to_return(body: response.to_json, status: 500)
      end
  ...
  describe "#get_fw_stats" do
    context "when the response is 200" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/fw/stats/").to_return(body: response.to_json)
      end
    ...
    context "when the response is 400" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/fw/stats/").to_return(body: response.to_json, status: 400)
      end
    ...
    context "when the response is 420" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/fw/stats/").to_return(body: response.to_json, status: 420)
      end
    ...
    context "when the response is 500" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/fw/stats/").to_return(body: response.to_json, status: 500)
      end
  ...
  describe "#get_fw_systems" do
    context "when the response is 200" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/fw/systems/").to_return(body: response.to_json)
      end
    ...
    context "when the response is 400" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/fw/systems/").to_return(body: response.to_json, status: 400)
      end
    ...
    context "when the response is 420" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/fw/systems/").to_return(body: response.to_json, status: 420)
      end
    ...
    context "when the response is 500" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/fw/systems/").to_return(body: response.to_json, status: 500)
      end
  ...
  describe "#get_fw_wars" do
    context "when the response is 200" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/fw/wars/").to_return(body: response.to_json)
      end
    ...
    context "when the response is 400" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/fw/wars/").to_return(body: response.to_json, status: 400)
      end
    ...
    context "when the response is 420" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/fw/wars/").to_return(body: response.to_json, status: 420)
      end
    ...
    context "when the response is 500" do
      ...
      before do
        stub_request(:get, "https://esi.evetech.net/latest/fw/wars/").to_return(body: response.to_json, status: 500)
      end
